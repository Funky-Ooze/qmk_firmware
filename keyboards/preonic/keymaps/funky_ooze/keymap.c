...
[1] = LAYOUT_ortho_5x12(
	_______,	DE_EXLM,	DE_AT,		DE_HASH,	DE_DLR,		DE_PERC,	DE_CIRC,	DE_AMPR,	DE_ASTR,	DE_LPRN,	DE_RPRN,	_______,
	EXIT,		DE_EXLM,	DE_AT,		DE_HASH,	DE_DLR,		DE_PERC,	DE_CIRC,	DE_AMPR,	DE_ASTR,	DE_LPRN,	DE_RPRN,	_______,
...
[2] = LAYOUT_ortho_5x12(
	_______,	SMILE,		WINK,		LAUGH,		KC_4,		KC_5,		KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		_______,
	...
	_______,	KC_F7,		KC_F8,		KC_F9,		KC_F10,		KC_F11,		KC_F12,		_______,	KC_PGUP,	KC_PGDN,	XXXXXXX,	KC_MNXT,
	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	DE_BSLS,	KC_VOLD,	KC_VOLU,	KC_MPLY
),
...
[4] = LAYOUT_ortho_5x12(
	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,
	KC_DEL,	    KC_UP,		_______,	_______,	_______,	_______,	_______,	_______,	PROEM,		EMTSK,		_______,	_______,
	KC_LEFT,	KC_DOWN,	KC_RGHT,	_______,	_______,	_______,	_______,	_______,	_______,    _______,    _______,	_______,
	KC_DEL,	    KC_ENT,		KC_BSPC,	_______,	_______,	_______,	_______,	TO_START,	TO_END,	    _______,    _______,	_______,
	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______
...
[5] = LAYOUT_ortho_5x12(
	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,
	_______,	PASSW,		PWHOME,		_______,	_______,	_______,	_______,	PROEM,		EMTSK,		_______,	_______,	_______,
	_______,	LOGIN,		_______,	_______,	_______,	_______,	_______,	_______,	TASK,		_______,	_______,	_______,
	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,    _______,	_______,
	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______,	_______
